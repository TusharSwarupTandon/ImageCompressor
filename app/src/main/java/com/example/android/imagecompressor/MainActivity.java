package com.example.android.imagecompressor;
...
public class MainActivity extends AppCompatActivity 
{
    ...
    File path = new File(Environment.getExternalStorageDirectory().getAbsolutePath() + "/compressedPictures");
        ...
        btnCompress.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try
                {
                    ...
                    txtCompressed.setText("Size: " + finalBitmap.getByteCount()/1024 +" KB");
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(resultCode == RESULT_OK)
        {
            ...
            try
            {
                ...
                txtOriginal.setText("Size " + (selectedImage.getByteCount())/1024 +" KB" );
            }
